...
export {
  ...
  tgbResolverServerFeaturesAuthJoinCodeEndpoint as getJoinCode,
  tgbResolverServerFeaturesAuthJoinEndpoint as joinWithCode,
  tgbResolverServerFeaturesAuthRevokeEndpoint as revokeSession,
  tgbResolverServerFeaturesAuthRotateEndpoint as rotateJoinCode,
  tgbResolverServerFeaturesAuthSessionsEndpoint as listSessions,
...
export type {
  ...
  ClientOptions,
  CodeOutputBody as JoinCodeSnapshot,
  ...
  JoinOutputBody as DeviceSessionSnapshot,
  MoveAssetRequest,
  ...
  SeekPlaybackRequest,
  SessionDto as AuthSessionSnapshot,
